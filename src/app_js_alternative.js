...
const REGISTERED = String.fromCharCode(174); // ®
...
const infoPages = [
  {
    id: 'intro',
    title: `Qu'est-ce que le RITMO${REGISTERED} ?`,
    content: (
      <div className="space-y-6">
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg">
          <h3 className="text-2xl font-bold text-indigo-900 mb-4">RITMO{REGISTERED} : Retraitement de l'Information Traumatique par les Mouvements Oculaires</h3>
          <p className="text-gray-700 leading-relaxed">
            Le RITMO{REGISTERED} est une technique innovante qui combine l'EMDR (Eye Movement Desensitization and Reprocessing), l'hypnose éricksonienne et la PNL pour accompagner les personnes et libérer les blocages émotionnels.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-500">
            ...
            <p className="text-gray-700">
              Le RITMO{REGISTERED} utilise des stimulations bilatérales (visuelles, auditives ou kinesthésiques) pour activer les zones du cerveau impliquées dans le retraitement des souvenirs. Ce processus permet de "digérer" l'événement en le séparant de l'émotion ressentie.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-green-500">
            ...
            <p className="text-gray-700">
              Une à quelques séances suffisent dans la majorité des cas. Le RITMO{REGISTERED} est reconnu par l'OMS et fait appel à notre capacité naturelle d'auto-guérison grâce à la plasticité du cerveau.
            </p>
          </div>
        </div>

        <div className="bg-indigo-900 text-white p-6 rounded-lg">
          <h4 className="font-bold text-xl mb-4">Applications du RITMO{REGISTERED}</h4>
  ...
  {
    id: 'protocole',
    title: `Les 8 Étapes du Protocole RITMO${REGISTERED}`,
    content: (
...
const revisionCards = [
  {
    ...
    content: `Le RITMO${REGISTERED} combine trois approches complémentaires : l'EMDR pour le retraitement, l'hypnose éricksonienne pour les ressources internes, et la PNL pour le recadrage cognitif.`,
  ...
  },
  {
    ...
    icon: '⚡',
    title: 'Point clé',
    content: `L'amygdale (émotions) peut inhiber l'hippocampe (logique). Le RITMO${REGISTERED} aide à restaurer l'équilibre entre ces zones cérébrales.`,
    color: 'from-orange-500 to-red-500'
  },
  {
    type: 'retenir',
